...
class Rendering:
	def __init__(self, success, title, is_parent, args, kwargs):
		...
		self.dynamic_feed = offline_update.cli.from_command_line and offline_update.cli.dynamic_feed
	...
	def __enter__(self, *args, **kwargs):
		...
		offline_update.LOG_BUFFER.append(
			{
				"message": self._title,
				"prefix": _prefix,
				"color": None,
	...
	def render_screen(self):
		...
		for l in offline_update.LOG_BUFFER:
